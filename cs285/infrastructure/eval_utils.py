...
def sample_trajectory(env: gym.Env, policy, max_length: int) -> Dict[str, np.ndarray]:
...
def sample_trajectories(
    env: gym.Env, policy, min_timesteps_per_batch: int, max_length: int
...
def sample_n_trajectories(env: gym.Env, policy, ntraj: int, max_length: int):
